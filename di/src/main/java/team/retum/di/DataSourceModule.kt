...
import team.retum.data.remote.datasource.implementation.BugReportDataSourceImpl
...
abstract class DataSourceModule {
    ...
    @Binds
    @Singleton
    abstract fun bindBugReportDataSource(
        bugReportDataSourceImpl: BugReportDataSourceImpl,
    ): BugReportDataSource
}