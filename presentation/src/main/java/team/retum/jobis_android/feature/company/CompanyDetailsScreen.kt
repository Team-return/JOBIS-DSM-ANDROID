...
@Stable
val CompanyDetailItems = listOf(
    R.string.company_list_representative_name,
    R.string.company_list_founded_at,
    R.string.company_list_worker_number,
    R.string.company_list_take,
    R.string.company_list_address1,
    R.string.company_list_address2,
    R.string.company_list_manager1,
    R.string.company_list_phone_number1,
    R.string.company_list_manager2,
    R.string.company_list_phone_number2,
    R.string.company_list_email,
    R.string.company_list_fax,
)
    ...
    Column {
        ...
        repeat(companyDetails.size) { index ->
            Row(
                ...
                Caption(
                    text = stringResource(CompanyDetailItems[index]),
                    color = JobisColor.Gray700,
                )
                Spacer(modifier = Modifier.width(24.dp))
                Caption(
                    text = companyDetails[index] ?: stringResource(id = R.string.company_list_null),
